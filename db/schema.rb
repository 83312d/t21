...
ActiveRecord::Schema[7.0].define(version: 2024_04_09_072354) do
  ...
  create_table "projects_students", force: :cascade do |t|
    ...
    t.index ["student_id", "project_id"], name: "index_projects_students_on_student_id_and_project_id", unique: true
  ...
  add_foreign_key "projects_students", "students"
end
